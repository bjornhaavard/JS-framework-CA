  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "1rem" }}>
      {products.map((product) => (
        <div
          key={product.id}
          style={{ width: "300px", border: "1px solid #e2e8f0", borderRadius: "0.5rem", overflow: "hidden", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", display: "flex", flexDirection: "column" }}
        >
          <div style={{ width: "100%", height: "300px", position: "relative" }}>
            <Image src={product.image.url} alt={product.image.alt} layout="fill" objectFit="cover" />
          </div>
